...
/**
 * Created by swf94 on 11/25/2016.
 */

public class PollDeleteAdapter extends ArrayAdapter<Poll> {
    ...
    public PollDeleteAdapter(Context context, int resource) {
        super(context, resource);
    }
    public PollDeleteAdapter(Context context, int layoutResourceID, List<Poll> items,int c){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        PollDeleteAdapter.PollViewHolder holder = null;

        LayoutInflater inflater = ((Activity) context).getLayoutInflater();
        row = inflater.inflate(layoutResourceId, parent, false);

        holder = new PollDeleteAdapter.PollViewHolder();
...
*/
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DeleteMsg deleteMessage=new DeleteMsg("http://iastate.510.com/SocialPolling", "Polls","key",x+"",pollclassList.get(position));
    ...
    private void setupItem(PollDeleteAdapter.PollViewHolder holder) {
