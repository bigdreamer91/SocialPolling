...
public class PollHistoryActivity extends AppCompatActivity {
    private ListView myListView;
    private PollHistoryListAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Context context = PollHistoryActivity.this;
        ...
        try {
            ...
            listAdapter = new PollHistoryListAdapter(this,R.layout.pollhistory_listview,pollclassList);
